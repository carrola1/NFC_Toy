...
class PN532{
 public:
  ...
  // ISO14443A functions
  bool readPassiveTargetID(uint8_t cardbaudrate, uint16_t timeout = 0); //timeout 0 means no timeout - will block forever.
  bool checkPassiveTargetStatus(uint8_t * uid, uint8_t * uidLength);
